...
// redirect to index module if click add btn
 if(redirect == 'add' || redirect == 'save'){
	setTimeout(function(){
		window.location.href = "<?php echo e(aurl(str_replace('#','', $form))); ?>";
	},5000);
 }
}
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\Bassil-Ali\Desktop\work-order\resources\views/admin/layouts/components/submit_form_ajax.blade.php ENDPATH**/ ?>