 ...
 <div class="btn-group">
	...
	<div class="dropdown-menu" role="menu">
		<a href="<?php echo e(aurl('/userrole/'.$id.'/edit')); ?>" class="dropdown-item" ><i class="fas fa-edit"></i> <?php echo e(trans('admin.edit')); ?></a>
		<a href="<?php echo e(aurl('/userrole/'.$id)); ?>" class="dropdown-item" ><i class="fa fa-eye"></i> <?php echo e(trans('admin.show')); ?></a>
...
<div class="modal fade" id="delete_record<?php echo e($id); ?>">
	<div class="modal-dialog">
		...
		<?php /**PATH C:\Users\Bassil-Ali\Desktop\work-order\resources\views/admin/userrole/buttons/actions.blade.php ENDPATH**/ ?>