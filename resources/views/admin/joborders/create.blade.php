...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
	<div class="form-group">
		...
		{!! Form::select('Measurement',['Bank Card'=>trans('admin.Bank Card'),'Electronic Transfer'=>trans('admin.Electronic Transfer'),'Receivables (Checks)'=>trans('admin.Receivables (Checks)'),'Receivables (Account)'=>trans('admin.Receivables (Account)'),'Cash (Instant Check)'=>trans('admin.Cash (Instant Check)'),],old('Measurement'),['class'=>'form-control select2','placeholder'=>trans('admin.choose')]) !!}
	</div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
