...
@include("admin.layouts.components.submit_form_ajax",["form"=>"#files"])
	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a href="{{aurl('files/'.$files->id)}}" class="dropdown-item" style="color:#343a40">
...
{!! Form::open(['url'=>aurl('/files/'.$files->id),'method'=>'put','id'=>'files','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
<div class="row">
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        ...
        {!! Form::text('file_name', $files->file_name ,['class'=>'form-control','placeholder'=>trans('admin.file_name')]) !!}
    </div>
</div>
