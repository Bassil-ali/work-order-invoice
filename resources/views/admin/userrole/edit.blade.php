	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a href="{{aurl('userrole/'.$userrole->id)}}" class="dropdown-item" style="color:#343a40">
...
{!! Form::open(['url'=>aurl('/userrole/'.$userrole->id),'method'=>'put','id'=>'userrole','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
<div class="row">

<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
		<div class="form-group">
				{!! Form::label('user_name',trans('admin.user_name'),['class'=>'control-label']) !!}
{!! Form::select('user_name',App\Models\Admin::pluck('name','id'), $userrole->user_name ,['class'=>'form-control select2','placeholder'=>trans('admin.user_name')]) !!}
		</div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
		<div class="form-group">
